...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/ryzenop07/rizz")
...
CUSTOM_API_KEY = getenv("CUSTOM_API_KEY", None)
CUSTOM_API_BASE_URL = getenv("CUSTOM_API_BASE_URL", "https://api.thequickearn.xyz")
